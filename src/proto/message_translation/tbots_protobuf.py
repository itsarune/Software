...
def create_world_state(
    yellow_robot_states, blue_robot_states, ball_location, ball_velocity
):
    ...
    for robot_id, robot_state in enumerate(yellow_robot_states):
        world_state.yellow_robots[robot_id].CopyFrom(robot_state)

    for robot_id, robot_state in enumerate(blue_robot_states):
        world_state.blue_robots[robot_id].CopyFrom(robot_state)
