...
from software.simulated_tests.ball_kicked import BallEventuallyKicked
...
from software.simulated_tests.kicker_double_touch import KickerAlwaysNotDoubleTouch
