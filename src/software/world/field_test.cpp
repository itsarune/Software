...
TEST(TestUtilsTest, create_division_b_field)
{
    ...
    EXPECT_EQ(Point(1.5, 0.0), field.penaltyFriendly());
    EXPECT_EQ(Point(-1.5, 0.0), field.penaltyEnemy());
...
TEST(TestUtilsTest, create_division_a_field)
{
    ...
    EXPECT_EQ(Point(2, 0.0), field.penaltyFriendly());
    EXPECT_EQ(Point(-2, 0.0), field.penaltyEnemy());
