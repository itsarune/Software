...
class MotorService
{
   ...
   private:
    ...
    std::unordered_map<int, int32_t> readAllVelocities();
    void writeAllVelocities(int front_left_motor_speed, int back_left_motor_speed, int back_right_motor_speed, int front_right_motor_speed, int dribbler_speed);
